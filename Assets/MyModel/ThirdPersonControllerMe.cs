...
#endif
    public class ThirdPersonControllerMe : MonoBehaviour
    {
        [Header("Player")]
        ...
        private Transform sittableTransform;
        ...
        {
            if (other.CompareTag("Sittable"))
            {
                canSit = true;
                sittableTransform = other.transform;
            }
        }
